...
class GATECHSegmentation(SegmentationDataset):
    """ S. H. Raza, M, et al. “Geometric context from videos. In CVPR 2013. """

    NUM_CLASS = 8

    def __init__(self, root=os.path.expanduser('~/.mxnet/dataset/GATECH'), split='train',
                 mode=None, transform=None, **kwargs):
        super(GATECHSegmentation, self).__init__(root, split, mode, transform, **kwargs)
