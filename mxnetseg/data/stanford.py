...
class StanfordSegmentation(SegmentationDataset):
    """
    ...
    def __init__(self, root=os.path.expanduser('~/.mxnet/dataset/Stanford10'), split='train', mode=None, transform=None,
                 **kwargs):
        super(StanfordSegmentation, self).__init__(root, split, mode, transform, **kwargs)
