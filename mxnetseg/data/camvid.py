...
class CamVidSegmentation(SegmentationDataset):
    """
    ...
    def __init__(self, root=os.path.expanduser('~/.mxnet/dataset/CamVid'), split='train',
                 mode=None, transform=None, **kwargs):
        super(CamVidSegmentation, self).__init__(root, split, mode, transform, **kwargs)
