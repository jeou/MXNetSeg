...
class SunRGBDSegmentation(SegmentationDataset):
    ...
    def __init__(self, root=os.path.expanduser('~/.mxnet/dataset/SUNRGBD'), split='train', mode=None, transform=None,
                 **kwargs):
        super(SunRGBDSegmentation, self).__init__(root, split, mode, transform, **kwargs)
    ...
    def classes(self):
        return ('wall', 'floor', 'cabinet', 'bed', 'chair', 'sofa', 'table',
                ...
                'floor_mat', 'clothes', 'ceiling', 'books', 'fridge', 'tv', 'paper',
                'towel', 'shower_curtain', 'box', 'whiteboard', 'person',
