...
from mxnetseg.modules import FCNHead, ConvBlock, GlobalFlow, DepthSepConvolution

__all__ = ['get_canet', 'CANet']


class CANet(SegBaseResNet):
    """
    Chained Context Aggregation Network
...
class _CAHead(nn.HybridBlock):
    """
    Chained Context Aggregation Module and Decoder.
    """
