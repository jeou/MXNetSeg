...
from mxnetseg.modules import FCNHead, PyramidPooling
...
class PSPNet(SegBaseResNet):
    ...
    def __init__(self, nclass, backbone='resnet50', aux=True, height=None, width=None,
        ...
        super(PSPNet, self).__init__(nclass, aux, backbone, height, width, base_size, crop_size, pretrained_base,
                                     dilate=True, norm_layer=norm_layer, norm_kwargs=norm_kwargs)
