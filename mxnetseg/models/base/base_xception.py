...
class SegBaseXception(SegBaseModel, ABC):
    ...
    def __init__(self, nclass: int, aux: bool, backbone: str = 'xception65', height: int = None,
                 width: int = None, base_size: int = 520, crop_size: int = 480,
                 pretrained_base: bool = True, dilate=True, **kwargs):
        ...
        self.base_channels = (128, 728, 2048)
